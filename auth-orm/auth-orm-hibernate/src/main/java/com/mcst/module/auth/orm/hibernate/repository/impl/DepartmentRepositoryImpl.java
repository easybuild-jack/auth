...
import com.mcst.module.auth.orm.hibernate.persistence.repository.DepartmentJpaRepository;
import com.mcst.module.auth.orm.repository.IDepartmentRepository;

public class DepartmentRepositoryImpl extends BaseHibernateRepositoryImpl<DepartmentJpaRepository, DepartmentDto, Department, String> implements IDepartmentRepository {
}

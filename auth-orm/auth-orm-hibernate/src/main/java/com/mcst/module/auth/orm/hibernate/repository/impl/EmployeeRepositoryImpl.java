...
import com.mcst.module.auth.orm.hibernate.persistence.mapper.EmployeeMapper;
import com.mcst.module.auth.orm.repository.IEmployeeRepository;

public class EmployeeRepositoryImpl extends BaseHibernateRepositoryImpl<EmployeeMapper, EmployeeDto, Employee, String> implements IEmployeeRepository {
}

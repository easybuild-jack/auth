...
import com.mcst.module.auth.orm.hibernate.persistence.repository.RoleResourceJpaRepository;
import com.mcst.module.auth.orm.repository.IRoleResourceRepository;

public class RoleResourceRepositoryImpl extends BaseHibernateRepositoryImpl<RoleResourceJpaRepository, RoleResourceDto, RoleResource, String> implements IRoleResourceRepository {
}

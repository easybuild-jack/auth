 ...
 * @author liuyijun
 */
public class EmployeeApiScImpl extends BaseApiRemoteImpl<IEmployeeRemote, EmployeeResp, String, EmployeeReq> implements IEmployeeApi {
    @Resource
    ...
    public BaseResult<?> loginOut(UserData userData) {
        return this.employeeRemote.loginOut(userData);
    }
